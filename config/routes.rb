Rails.application.routes.draw do
  ...
  get("/flexible/payment/:int/:year/:amount", {:controller => "calculations", :action => "flex_payment"})
  get("/flexible/random/:num/:sec", {:controller => "calculations", :action => "flex_random"})
